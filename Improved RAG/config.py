...
# Choose between 'gemini' (Google Gemini API) or 'sentence_transformers' (local model)
# Gemini is the default provider with automatic fallback to local models when daily limits are exceeded
EMBEDDING_PROVIDER = os.getenv("EMBEDDING_PROVIDER", "gemini")  # Default to Gemini
...
SENTENCE_TRANSFORMERS_MODEL = "Snowflake/snowflake-arctic-embed-m"
...
if EMBEDDING_PROVIDER == "gemini":
    ...
    EMBEDDING_MODEL_NAME = SENTENCE_TRANSFORMERS_MODEL
    EMBEDDING_DIMENSION = 768  # Default for Snowflake model
...
MODEL_QUOTA = {
    ...
    "embedding": (100, 30_000, 1_000),  # Gemini Embedding: 100 RPM, 30K TPM, 1,000 RPD
}
